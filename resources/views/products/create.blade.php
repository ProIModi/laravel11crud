          ...
          <div class="col-md-10">
            <div class="card border-0 shadow-lg my-4">
              <div class="card-header">
                <h3 class="text-black h4">Create Product</h3>
              </div>
              ...
              <form enctype="multipart/form-data" action="{{ route('products.store') }}" method ="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea placeholder="Description" class="form-control" name="description" cols="30" rows="5" value="{{ old('description') }}"> </textarea>
                  </div>
                  <div class="mb-3">
